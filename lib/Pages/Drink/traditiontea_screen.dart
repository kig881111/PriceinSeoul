...
class Traditiontea extends StatefulWidget{
  @override
  TraditionteaState createState() => new TraditionteaState();
}

class TraditionteaState extends State<Traditiontea>{
              ...
              future: rootBundle.loadString(jsonuri),
               builder: (context, snapshot){
                  ...
                  if(MYDATA != null)
                  {
                    ...
                    {
                      if(_items['prdlst_desc'] == "다방 국산차(녹차)")
                      {
                        MYDATA_.add(_items);
                      }
                    }
