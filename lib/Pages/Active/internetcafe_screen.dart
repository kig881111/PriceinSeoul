...
class Internetcafe extends StatefulWidget{
  @override
  InternetcafeState createState() => new InternetcafeState();
}

class InternetcafeState extends State<Internetcafe>{
